...
| **pi-command-panel** | `/` as the first input opens a fuzzy command panel above the editor; elsewhere `/` remains literal. The real editor filters; Tab completes without closing, while Enter runs the command. |
